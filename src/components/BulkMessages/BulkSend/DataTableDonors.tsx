...
const DataTableDonors = () => {
    ...
    return (
        <section className="data-table-common py-4 dark:border-strokedark dark:bg-boxdark">
            <div className="flex justify-between px-0 pb-4">
                <div className="w-100">
                    <input
                        type="text"
                        value={globalFilter ?? ""}
            ...
            <div className="flex justify-between border-t border-stroke px-0 pt-5 dark:border-strokedark">
                <div className="flex">
                    <button
...
export default DataTableDonors;
