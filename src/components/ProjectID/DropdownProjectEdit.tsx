    ...
    return (
        <div className="relative flex">
            ...
            <div
                ...
                className={`absolute right-0 top-full z-40 w-20 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark ${dropdownOpen === true ? "block" : "hidden"
                    }`}
            >
                <button
                    className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4"
                    onClick={() => window.location.href = "/projectID"}
                >
                    詳細
                </button>
            </div>
...
export default DropdownProjectEdit;
