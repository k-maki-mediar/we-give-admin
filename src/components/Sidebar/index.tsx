        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item donation-amounts --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("donationamounts")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/" ||
                          pathname.includes("donationamounts")) &&
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/donationamounts/dashboard"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/donationamounts/dashboard" &&
                                "text-white"
                                } `}
                            >
                              ダッシュボード
                          ...
                          <li>
                            <Link
                              href="/donationamounts/fundslist"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/donationamounts/fundslist" &&
                                "text-white"
                                } `}
                            >
                              寄付金一覧
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/orgInfo/org-member" &&
                                "text-white"
                                } `}
                            >
                              メンバー管理
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("donationctrl")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/" ||
                          pathname.includes("donationctrl")) &&
                          "bg-graydark dark:bg-meta-4"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/donationctrl/don-list"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/donationctrl/don-list" &&
                                "text-white"
                                } `}
                            >
                              寄付一覧
                          ...
                          <li>
                            <Link
                              href="/donationctrl/high-don-list"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/donationctrl/high-don-list" &&
                                "text-white"
                                } `}
                            >
                              高額寄付一覧
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/project/projectlist" &&
                                "text-white"
                                } `}
                            >
                              プロジェクト一覧
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/project/projectsettings" &&
                                "text-white"
                                } `}
                            >
                              プロジェクト設定
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/dashboard/marketing" &&
                                "text-white"
                                }`}
                            >
                              Marketing
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/pro-form-elements" &&
                                "text-white"
                                }`}
                            >
                              Pro Form Elements
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/pro-form-layout" &&
                                "text-white"
                                } `}
                            >
                              Pro Form Layout
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/tables" ||
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/tables"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/tables" && "text-white"
                                }`}
                            >
                              Tables
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/tables/pro-tables" &&
                                "text-white"
                                }`}
                            >
                              Pro Tables
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/pages/settings"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/pages/settings" && "text-white"
                                }`}
                            >
                              Settings
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/pages/data-tables" &&
                                "text-white"
                                } `}
                            >
                              Data Tables
                          ...
                          <li>
                            <Link
                              href="/pages/team"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/pages/team" && "text-white"
                                }`}
                            >
                              Teams
                              <span className="absolute right-4 block rounded bg-primary px-2 py-1 text-xs font-medium text-white">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/messages" ||
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/messages/donorschat"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/messages/donorschat" &&
                                "text-white"
                                } `}
                            >
                              チャット
                          ...
                          <li>
                            <Link
                              href="/messages/bulkmessages"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/messages/bulkmessages" &&
                                "text-white"
                                } `}
                            >
                              メッセージ一括送信
              ...
              <li>
                <Link
                  href="/inbox"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("inbox") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  href="/invoice"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("invoice") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/auth/coming-soon" && "text-white"
                                }`}
                            >
                              Coming Soon
                              <span className="absolute right-4 block rounded bg-primary px-2 py-1 text-xs font-medium text-white">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/auth/two-step-verification" &&
                                "text-white"
                                }`}
                            >
                              2 Step Verification
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/auth/under-maintenance" &&
                                "text-white"
                                }`}
                            >
                              Under Maintenance
