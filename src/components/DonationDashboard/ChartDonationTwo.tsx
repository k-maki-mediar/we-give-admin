...
interface ChartDonationTwoState {
    series: {
        name: string;
        data: number[];
    }[];
...
const ChartDonationTwo: React.FC = () => {
    const [state, setState] = useState<ChartDonationTwoState>({
        series: [
            {
...
export default ChartDonationTwo;
